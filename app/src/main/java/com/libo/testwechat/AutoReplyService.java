...
//                back2Me();
    ...
    public void findRequestMessage() {
        AccessibilityNodeInfo nodeInfo = getRootInActiveWindow();
        if (nodeInfo != null) {
            List<AccessibilityNodeInfo> list = nodeInfo.findAccessibilityNodeInfosByViewId("@id/a5q");
                ...
                new Runnable() {
                    ...
                    public void run() {
                        while (true) {
                            ...
                            int x = (int) (screenWidth * a);
                            int y = (int) (screenHeight * b);
